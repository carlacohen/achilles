...
p1 <- ggplot(df_all, aes(x = orig.ident, y = nCount_RNA, fill = low_lib_size))+
    ...
    scale_fill_viridis_d(begin = 0, end = 0.75)+
    theme_cowplot()+
    ggtitle("Statistical filtering: Low library size after ambient RNA & doublet removal")
...
p2 <- ggplot(df_all, aes(x = orig.ident, y = nFeature_RNA, fill = low_n_features))+
    ...
    scale_fill_viridis_d(begin = 0, end = 0.75)+
    theme_cowplot()+
    ggtitle("Statistical filtering: Low number of features after ambient RNA & doublet removal")
...
p3 <- ggplot(df_all, aes(x = orig.ident, y = percent_mt, fill = high_percent_mt))+
    ...
    scale_fill_viridis_d(begin = 0, end = 0.75)+
    theme_cowplot()+
    ggtitle("Statistical filtering: Mitochondrial reads after ambient RNA & doublet removal")
