...
Prior to assessing our metrics, we are going to perform filtering of those cells with less than 100 UMIs, keep cells with 300-6000 gene counts and with percent_mt < 10. These parameters can be updated for individual samples if required. 
...
Save as a Seurat object with suffix "_filtered_SeuratObject.rds".   
Convert to a SingleCellExperiment and save with suffix "_raw_filtered_SingleCellExp.rds".  
...
for(i in 1:length(so_filtered)){
    ...
    saveRDS(so[[i]], file = paste0("/project/tendonhca/ccohen/chromium/analysis/20230118_achilles/RDS_objects.dir/", so_filtered[[i]]@project.name, "_filtered_SeuratObject.rds"))
    ...
    saveRDS(se[[i]], paste0("/project/tendonhca/ccohen/chromium/analysis/20230118_achilles/RDS_objects.dir/", so_filtered[[i]]@project.name, "_raw_filtered_SingleCellExp.rds"))
}
...
## Visualisation of QC metrics after filtering 
