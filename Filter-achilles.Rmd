...
See /project/tendonhca/ccohen/git/achilles/docs/Filter-achilles.md  
...
for (i in 1:length(sce_empty)){
    QC_filters <- scuttle::perCellQCFilters(sce_empty[[i]], 
    ...
    QC_filters <- scuttle::perCellQCFilters(sce_decontX_doublet_filtered[[i]], 
                      sum.field = "nCount_RNA", 
                      detected.field = "nFeature_RNA",
                      sub.fields = "percent_mt")
...
```{r, include=FALSE}
#save the plot
ggsave("Filtered_Figures.dir/UMAP_percent_mt.png", p, device = "png", width = 12, height = 16, bg = "white")
ggsave("Filtered_Figures.dir/UMAP_percent_mt.pdf", p, device = "pdf", width = 12, height = 16, bg = "white")
```
...
```{r, include=FALSE}
#save the plot
ggsave("Filtered_Figures.dir/UMAP_nCount_RNA.png", p, device = "png", width = 12, height = 16, bg = "white")
ggsave("Filtered_Figures.dir/UMAP_nCount_RNA.pdf", p, device = "pdf", width = 12, height = 16, bg = "white")
```
...
```{r, include=FALSE}
#save the plot
ggsave("Filtered_Figures.dir/UMAP_nFeature_RNA.png", p, device = "png", width = 12, height = 16, bg = "white")
ggsave("Filtered_Figures.dir/UMAP_nFeature_RNA.pdf", p, device = "pdf", width = 12, height = 16, bg = "white")
```
